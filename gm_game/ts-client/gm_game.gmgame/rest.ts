 ...
 */
export type GmgameParams = object;

export interface GmgameQueryAllNftResponse {
  nft?: GmgameNft[];
...
/**
 * @title gmgame/gmgame/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/gm_game/gmgame/nft
   */
  queryNftAll = (
    query?: {
    ...
    this.request<GmgameQueryAllNftResponse, RpcStatus>({
      path: `/gm_game/gmgame/nft`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/gm_game/gmgame/nft/{index}
   */
  queryNft = (index: string, params: RequestParams = {}) =>
    this.request<GmgameQueryGetNftResponse, RpcStatus>({
      path: `/gm_game/gmgame/nft/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/gm_game/gmgame/params
   */
