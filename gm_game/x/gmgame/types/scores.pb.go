...
// source: gmgame/gmgame/scores.proto
...
func (*Scores) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b8212604b0256b9, []int{0}
}
...
func (m *Scores) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintScores(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
